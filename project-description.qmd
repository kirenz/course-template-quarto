...
| ---                   | ---           |  ---                  |
|@sec-topic-ideas        | Fri, Oct 28   | references/           |
|@sec-project-proposal   | Fri, 2 Dec   | references/           |
|@sec-draft-analysis     | Fri, Dec 9    | notebooks/            |
|@sec-peer-review-draft  | Fri, Dec 16   | use [](issue-template)|
|@sec-report             | Fr, Feb 3     | reports/              |
|@sec-slides-video       | Fri, Feb 10   | reports/              |
|@sec-github-repo      | Fri, Feb 10   | "Repo in final state" |
|@sec-comments          | We, Feb 15    | "Comment in Moodle"   |
|@sec-team-eval          | Fri,Feb 17    | "Fill out survey"     |
